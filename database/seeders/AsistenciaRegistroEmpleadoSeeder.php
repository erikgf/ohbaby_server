...
class AsistenciaRegistroEmpleadoSeeder extends Seeder
{
    ...
    private function v_20241101_01(): void{

        DB::beginTransaction();

        $archivo = "asistencias_masivas_v_20241101_01.csv";
        AsistenciaRegistroEmpleado::where("fecha",">=","2024-10-01")->forceDelete();
    ...
    private function v_20241106_01(): void{

        DB::beginTransaction();

        $archivo = "asistencias_masivas_v_20241106_01.csv";
        AsistenciaRegistroEmpleado::where("fecha",">=","2024-10-01")->forceDelete();
    ...
    private function v_20241129_01(): void{
        DB::beginTransaction();
    ...
    private function v_20241231_01(): void{
        DB::beginTransaction();

        $archivo = "asistencias_masivas_v_20241231_01.csv";
        AsistenciaRegistroEmpleado::where("fecha",">=","2024-12-01")->forceDelete();
